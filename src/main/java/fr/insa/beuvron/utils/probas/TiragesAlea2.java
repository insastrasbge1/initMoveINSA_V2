...
public class TiragesAlea2 {
    ...
    /**
     * choisi aléatoirement un indice i en considérant que poidsi/somme(poids)
     * (en ne considérant que les poids positifs) est la proba que i soit
     * choisi.
     * <pre>
    ...
    public static <V> V choixAleaPondere(List<V> valeurs, List<Double> poids, Random r) {
        ...
        return valeurs.get(choixIndicePondere( poids, r));
    }
    ...
    public static <V> List<V> choixMultiplesAleaPondere(int nbrChoix, List<V> valeurs,List<Double> poids, Random r) {
        ...
        for (int i = 0; i < nbrChoix; i++) {
            int unChoix = choixIndicePondere(curPoids, r);
