 ...
 */
@PageTitle("MoveINSA")
@Route(value = "partenaires/upload", layout = MainLayout.class)
public class UploadPartenaires extends VerticalLayout {

    private Upload upload;
    private MultiFileMemoryBuffer buffer;

    public UploadPartenaires() {
        this.buffer = new MultiFileMemoryBuffer();
        this.upload = new Upload(buffer);
        this.add(new H3("sélectionnez un fichier contenant un liste de partenaires"));
        this.add(new Paragraph("format attendu : une ref de partenaire par ligne"));
        ...
        this.upload.addSucceededListener((t) -> {
            ...
            try (Connection con = ConnectionPool.getConnection()) {
                Partenaire.createFromCSV(con, new BufferedReader(new InputStreamReader(in, StandardCharsets.UTF_8)));
            }
